...
execute as @a[scores={lmasu_ad_ev_ga=0..}] run scoreboard players set @s lmasu_ad_ev_ga -1
execute as @a[scores={lmasu_ad_ev_zmiv=0..}] run scoreboard players set @s lmasu_ad_ev_zmiv -1
