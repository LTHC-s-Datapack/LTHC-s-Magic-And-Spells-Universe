...
execute as @a[scores={lmasu_manatemp=..0,lmasu_manalvl=3,lmasu_mana=..15999}] run function lthc.lmasu:lthc.lmasu/main/mana_charger
execute as @a[scores={lmasu_manatemp=..0,lmasu_manalvl=4,lmasu_mana=..24999}] run function lthc.lmasu:lthc.lmasu/main/mana_charger
