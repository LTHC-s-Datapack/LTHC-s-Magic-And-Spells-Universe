...
#summon result
summon item ~ ~2 ~ {NoGravity:1b,Item:{id:"minecraft:fishing_rod",Count:1b,tag:{display:{Name:'{"translate":"Inondator","color":"#0044FF","bold":true}',Lore:['{"translate":"Water Power","color":"white","italic":false}']},RepairCost:10000,Unbreakable:1b,lmasu_inond:true}}}
#kill base item
kill @s
