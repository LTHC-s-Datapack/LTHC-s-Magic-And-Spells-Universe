...
execute at @s if entity @e[type=!#lthc.lmasu:lthc.lmasu/not_touched,tag=!lmasu_ovb,distance=..11] run execute as @e[type=!#lthc.lmasu:lthc.lmasu/not_touched,distance=..11] run function lthc.lmasu:lthc.lmasu/spells/sp3/fd_grw_effect
