...
execute if score @s lmasu_mglvl matches ..9 run scoreboard players add @s lmasu_mglvlxp 5
scoreboard players add @s lmasuc_noarrow 1
execute unless score @s lmasu_manalvl matches 4.. run scoreboard players add @s lmasu_manalvlxp 12
