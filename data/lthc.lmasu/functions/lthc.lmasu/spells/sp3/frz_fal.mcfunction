...
execute at @s if entity @e[type=!#lthc.lmasu:lthc.lmasu/not_touched,tag=!lmasu_ovb,distance=..10] run execute as @e[type=!#lthc.lmasu:lthc.lmasu/not_touched,distance=..10,sort=random,limit=1] run function lthc.lmasu:lthc.lmasu/spells/sp3/frz_fal_set
