...
execute at @s if entity @e[type=!#lthc.lmasu:lthc.lmasu/not_touched,tag=!lmasu_ovb,distance=..16] run function lthc.lmasu:lthc.lmasu/spells/sp2/dam_arrow_setting
