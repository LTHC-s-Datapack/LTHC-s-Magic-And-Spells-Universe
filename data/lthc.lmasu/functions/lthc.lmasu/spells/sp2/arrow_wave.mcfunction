...
execute at @s if entity @e[type=!#lthc.lmasu:lthc.lmasu/not_touched,tag=!lmasu_ovb,distance=..13] run function lthc.lmasu:lthc.lmasu/spells/sp2/arrow_wave_setting
