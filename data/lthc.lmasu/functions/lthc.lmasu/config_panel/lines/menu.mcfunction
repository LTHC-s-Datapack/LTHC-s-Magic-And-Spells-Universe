...
#Events
tellraw @s [{"text":"\n\n\u0020\u0020\u0020Events","bold":true,"underlined":true,"color":"light_purple"}]
...
tellraw @s {"text":"\n\u0020\u0020\u0020\u0020\u0020\u0020[Clear]","color":"gold","clickEvent":{"action":"run_command","value":"/function lthc.lmasu:lthc.lmasu/lmasu_clear_lag/lmasu_clear_lag"}}
