...
# Initializes the datapack at the first startup or new version (version format: xx.xx.xx (current 2.3 so 020300 (02.03.00)))
execute unless score $lthc.first_run lmasu.data matches 1 run function lthc.lmasu:lthc.lmasu/loading/first_run/main
execute if score $lthc.first_run lmasu.data matches 1 unless score $lthc.version lmasu.data matches 020300 run function lthc.lmasu:lthc.lmasu/loading/first_run/update
