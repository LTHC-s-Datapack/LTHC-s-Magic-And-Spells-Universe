...
execute as @e[type=zombie,scores={lmasu_mblvl=..4}] run effect give @s strength 21 0 true

execute as @e[type=zombie,scores={lmasu_mblvl=1..}] run effect give @s glowing 21 0 true
