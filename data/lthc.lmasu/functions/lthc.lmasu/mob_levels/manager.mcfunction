...
#Skeleton
execute as @e[type=skeleton,scores={lmasu_mblvl=0}, sort=random, limit=3, predicate=lthc.lmasu:lthc.lmasu/luck/1_of_10] run scoreboard players set @s lmasu_mblvl 1
execute as @e[type=skeleton,scores={lmasu_mblvl=0}, sort=random, limit=3, predicate=lthc.lmasu:lthc.lmasu/luck/1_of_10] run scoreboard players set @s lmasu_mblvl 2
execute as @e[type=skeleton,scores={lmasu_mblvl=0}, sort=random, limit=2, predicate=lthc.lmasu:lthc.lmasu/luck/1_of_10] run scoreboard players set @s lmasu_mblvl 3
execute as @e[type=skeleton,scores={lmasu_mblvl=0}, sort=random, limit=2, predicate=lthc.lmasu:lthc.lmasu/luck/1_of_125] run scoreboard players set @s lmasu_mblvl 4
