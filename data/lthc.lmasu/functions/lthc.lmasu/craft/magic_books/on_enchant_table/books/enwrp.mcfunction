...
summon item ~ ~2 ~ {Item:{id:"book",Count:1b,tag:{enwrp:true,display:{Name:'{"text":"[Book] End warp","color":"#FFFF00"}',Lore:['{"text":"this book is an end warp"}']},CustomModelData:2104}}}
kill @s
