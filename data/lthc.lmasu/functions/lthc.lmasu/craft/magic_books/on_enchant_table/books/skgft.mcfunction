...
summon item ~ ~2 ~ {Item:{id:"book",Count:1b,tag:{skgft:true,display:{Name:'{"translate":"[Book] Skys\' gift","color":"#FFFF00"}',Lore:['{"translate":"this book is a gift of skys"}']},CustomModelData:2103}}}
kill @s
