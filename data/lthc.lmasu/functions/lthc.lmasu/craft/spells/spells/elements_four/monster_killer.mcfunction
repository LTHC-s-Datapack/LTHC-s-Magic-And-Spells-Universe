# -------------------------
# Root Location: lthc.lmasu:lthc.lmasu/craft/spells/spells/elements_four/
...
advancement revoke @s only lthc.lmasu:lthc.lmasu/system/spells/four/spells_craft_monster_killer
