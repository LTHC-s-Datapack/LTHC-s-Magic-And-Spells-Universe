...
execute at @s if entity @e[type=!#lthc.lmasu:not_touched,distance=..10] run execute as @e[type=!#lthc.lmasu:not_touched,distance=..10,sort=random,limit=1] run function lthc.lmasu:spells/sp3/frz_fal_set
