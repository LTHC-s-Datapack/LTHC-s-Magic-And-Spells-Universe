...
execute at @s if entity @e[type=!#lthc.lmasu:not_touched,tag=!lmasu_ovb,distance=..17] run execute at @e[type=!#lthc.lmasu:not_touched,distance=..17] run function lthc.lmasu:spells/actions/lightning_burning_summon
