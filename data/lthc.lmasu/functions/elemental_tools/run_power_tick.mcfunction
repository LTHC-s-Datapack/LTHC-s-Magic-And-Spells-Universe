...
#Inondator
execute as @a[nbt={SelectedItem:{id:"minecraft:fishing_rod",tag:{lmasu_inond:true}}},predicate=!lthc.lmasu:is_in_nether] at @s run fill ~-1 ~ ~-1 ~1 ~ ~1 water replace lava
